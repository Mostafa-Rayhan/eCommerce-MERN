          ...
          >
            ...
            <div className="w-full flex justify-between items-center gap-4 mb-4">
              ...
              <input
                ...
                id=""
                className="w-2/3 border-2 rounded-md p-1"
                defaultValue={modalData?.owner_name}
              />
            </div>
